<template>
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        <label>验证码:</label>
        <input type="text" placeholder="请输入你的验证码" v-model="code" name="code"
          v-validate="{ required: true, regex: /^\d{6}$/ }" :class="{ invalid: errors.has('phone') }">
      ...
      <div class="content">
        <label>确认密码:</label>
        <!-- is:紧随的判断是否相等规则 -->
        <input type="text" placeholder="请输入你的确认密码" v-model="password1" name="password1"
